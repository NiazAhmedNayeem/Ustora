            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('admin.create-admin')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Admin Mobile</label>
                            <div class="col-sm-9">
                                <input type="number" class="form-control" id="horizontal-email-input" name="mobile"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Admin Image</label>
                            <div class="col-sm-9">
                                <input type="file" class="form-control" id="horizontal-email-input" name="image"/>
                            </div>
                        </div>
